...
class TradeExecutionOrchestrator
{
    ...
    /**
     * @return callable(?Checklist,array<int,array{checklist_item_id:int,title:string,category:string,reason:string}>,?string,?int,array<int,int>,array<int,array{checklist_item_id:int,title:string,category:string,reason:string}>):void
     */
    private function strictGateFailureHandler(): callable
    {
        return function (
            ?Checklist $checklist,
            array $failingRules,
